...
questionController.getQuestions = (_req, res, next) => {
  const questionQuery =
...
questionController.postQuestion = (req, _res, next) => {
  const url = new Date().toString(); // Placeholder, eventually will be websockets url.
...
questionController.setInactive = (req, _res, next) => {
